...
public class GepirStatisticsLineCountersCountClient implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * gepirStatisticsLineCountersCountClient Namespace URI =
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":gepirStatisticsLineCountersCountClient", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						"gepirStatisticsLineCountersCountClient", xmlWriter);
			}
	...
	public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
		...
		if (localIPAddressTracker) {
			elementList.add(new javax.xml.namespace.QName("http://www.gepir.gs1.org.vn/", "IPAddress"));
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static GepirStatisticsLineCountersCountClient parse(javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			GepirStatisticsLineCountersCountClient object = new GepirStatisticsLineCountersCountClient();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"gepirStatisticsLineCountersCountClient".equals(type)) {
							...
							return (GepirStatisticsLineCountersCountClient) vn.org.gs1.gepir.request.ExtensionMapper
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("http://www.gepir.gs1.org.vn/", "IPAddress")
				...
				if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.gepir.gs1.org.vn/", "HitCount")
					...
					object.setHitCount(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
