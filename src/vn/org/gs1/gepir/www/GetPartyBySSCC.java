 ...
 */
            ...
            /**
            *  GetPartyBySSCC bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetPartyBySSCC
        ...
        /* This type was generated from the piece of schema that had
                ...
                */
                        ...
                        /**
                        * field for RequestedSscc
                        */

                        
                                    protected java.lang.String localRequestedSscc ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localRequestedSsccTracker = false ;

                           public boolean isRequestedSsccSpecified(){
                               return localRequestedSsccTracker;
                           }
                           ...
                           */
                           public  java.lang.String getRequestedSscc(){
                               return localRequestedSscc;
                           }
                            ...
                            /**
                               ...
                               * @param param RequestedSscc
                               */
                               public void setRequestedSscc(java.lang.String param){
                            localRequestedSsccTracker = param != null;
                                   
                                            this.localRequestedSscc=param;
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetPartyBySSCC",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetPartyBySSCC",
                           xmlWriter);
                                     ...
                                     if (localRequestedSsccTracker){
                                    namespace = "http://www.gepir.gs1.org.vn/";
                                    writeStartElement(null, namespace, "requestedSscc", xmlWriter);
                             

                                          if (localRequestedSscc==null){
                                              // write the nil attribute
                                              
                                                     throw new org.apache.axis2.databinding.ADBException("requestedSscc cannot be null!!");
                                                  
                                          }else{

                                        
                                                   xmlWriter.writeCharacters(localRequestedSscc);
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localRequestedSsccTracker){
                                      elementList.add(new javax.xml.namespace.QName("http://www.gepir.gs1.org.vn/",
                                        ...
                                        if (localRequestedSscc != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localRequestedSscc));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("requestedSscc cannot be null!!");
                                        }
                                    } if (localRequestedLanguagesTracker){
    ...
    public static class Factory{
        ...
        */
        public static GetPartyBySSCC parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetPartyBySSCC object =
                new GetPartyBySSCC();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetPartyBySSCC".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetPartyBySSCC)vn.org.gs1.gepir.request.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                   ...
                   if (tempAttribVersion!=null){
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.gepir.gs1.org.vn/","requestedSscc").equals(reader.getName())){
                                
                                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                    if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                        throw new org.apache.axis2.databinding.ADBException("The element: "+"requestedSscc" +"  cannot be null");
                                    }
                                    

                                    java.lang.String content = reader.getElementText();
                                    
                                              object.setRequestedSscc(
