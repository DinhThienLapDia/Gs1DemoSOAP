...
/**
 * GetOwnerOfGLN bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class GetOwnerOfGLN implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * GetOwnerOfGLN Namespace URI = http://www.gepir.gs1.org.vn/ Namespace
	 * Prefix = ns3
	 */
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":GetOwnerOfGLN", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "GetOwnerOfGLN", xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static GetOwnerOfGLN parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			GetOwnerOfGLN object = new GetOwnerOfGLN();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"GetOwnerOfGLN".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (GetOwnerOfGLN) vn.org.gs1.gepir.request.ExtensionMapper.getTypeObject(nsUri, type,
									reader);
						}
