...
public class ArrayOfString implements org.apache.axis2.databinding.ADBBean {
	...
	/**
	 * field for Keyword This was an Array!
	 */
	...
	public void addKeyword(java.lang.String param) {
		...
		java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localKeyword);
		list.add(param);
		this.localKeyword = (java.lang.String[]) list.toArray(new java.lang.String[list.size()]);
	...
	public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				...
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "ArrayOfString", xmlWriter);
			}
		...
		if (localKeywordTracker) {
			if (localKeyword != null) {
				for (int i = 0; i < localKeyword.length; i++) {
					...
					if (localKeyword[i] != null) {
						elementList.add(new javax.xml.namespace.QName("http://www.gepir.gs1.org.vn/", "keyword"));
						elementList
								.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localKeyword[i]));
					} else {
	...
	public static class Factory {
		...
		public static ArrayOfString parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"ArrayOfString".equals(type)) {
							...
							return (ArrayOfString) vn.org.gs1.gepir.request.ExtensionMapper.getTypeObject(nsUri, type,
									reader);
						}
				...
				if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.gepir.gs1.org.vn/", "keyword")
					...
					while (!loopDone1) {
						...
						if (reader.isEndElement()) {
							...
							if (new javax.xml.namespace.QName("http://www.gepir.gs1.org.vn/", "keyword")
									.equals(reader.getName())) {
								list1.add(reader.getElementText());
					...
					object.setKeyword((java.lang.String[]) list1.toArray(new java.lang.String[list1.size()]));
