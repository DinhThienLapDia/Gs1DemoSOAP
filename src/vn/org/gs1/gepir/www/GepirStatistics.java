...
public class GepirStatistics implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * gepirStatistics Namespace URI = http://www.gepir.gs1.org.vn/ Namespace
	 * Prefix = ns3
	 */
	...
	/**
	 * field for StatisticsLine This was an Array!
	 */
	 ...
	 * 
	 * @param param
	 *            vn.org.gs1.gepir.www.GepirStatisticsLine
	 */
	public void addStatisticsLine(vn.org.gs1.gepir.www.GepirStatisticsLine param) {
		...
		java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localStatisticsLine);
		list.add(param);
		this.localStatisticsLine = (vn.org.gs1.gepir.www.GepirStatisticsLine[]) list
				.toArray(new vn.org.gs1.gepir.www.GepirStatisticsLine[list.size()]);
	...
	public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":gepirStatistics", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "gepirStatistics",
						xmlWriter);
			}
		...
		if (localPeriodBegin == null) {
			...
			xmlWriter.writeCharacters(
					org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localPeriodBegin));
			...
			if (localStatisticsLine != null) {
				for (int i = 0; i < localStatisticsLine.length; i++) {
					if (localStatisticsLine[i] != null) {
						localStatisticsLine[i].serialize(
								new javax.xml.namespace.QName("http://www.gepir.gs1.org.vn/", "statisticsLine"),
								xmlWriter);
					} else {
	...
	public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
		...
		elementList.add(new javax.xml.namespace.QName("http://www.gepir.gs1.org.vn/", "periodBegin"));
		...
		elementList.add(new javax.xml.namespace.QName("http://www.gepir.gs1.org.vn/", "periodEnd"));
		...
		if (localStatisticsLineTracker) {
			if (localStatisticsLine != null) {
				for (int i = 0; i < localStatisticsLine.length; i++) {
					...
					if (localStatisticsLine[i] != null) {
						elementList
								.add(new javax.xml.namespace.QName("http://www.gepir.gs1.org.vn/", "statisticsLine"));
	...
	public static class Factory {
		...
		public static GepirStatistics parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			GepirStatistics object = new GepirStatistics();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"gepirStatistics".equals(type)) {
							...
							return (GepirStatistics) vn.org.gs1.gepir.request.ExtensionMapper.getTypeObject(nsUri, type,
									reader);
						}
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("http://www.gepir.gs1.org.vn/", "periodBegin")
								.equals(reader.getName())) {

					nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
					if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
						throw new org.apache.axis2.databinding.ADBException(
								"The element: " + "periodBegin" + "  cannot be null");
					}

					java.lang.String content = reader.getElementText();

					object.setPeriodBegin(org.apache.axis2.databinding.utils.ConverterUtil.convertToDate(content));
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("http://www.gepir.gs1.org.vn/", "periodEnd")
								.equals(reader.getName())) {

					nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
					if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
						throw new org.apache.axis2.databinding.ADBException(
								"The element: " + "periodEnd" + "  cannot be null");
					}

					java.lang.String content = reader.getElementText();

					object.setPeriodEnd(org.apache.axis2.databinding.utils.ConverterUtil.convertToDate(content));
				...
				if (reader.isStartElement()
					...
					while (!loopDone3) {
						...
						if (reader.isEndElement()) {
							...
							if (new javax.xml.namespace.QName("http://www.gepir.gs1.org.vn/", "statisticsLine")
									.equals(reader.getName())) {
								list3.add(vn.org.gs1.gepir.www.GepirStatisticsLine.Factory.parse(reader));
					...
					object.setStatisticsLine(
							(vn.org.gs1.gepir.www.GepirStatisticsLine[]) org.apache.axis2.databinding.utils.ConverterUtil
									.convertToArray(vn.org.gs1.gepir.www.GepirStatisticsLine.class, list3));
