...
/**
 * GetItemByGTIN bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class GetItemByGTIN implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * GetItemByGTIN Namespace URI = http://www.gepir.gs1.org.vn/ Namespace
	 * Prefix = ns3
	 */
	...
	public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":GetItemByGTIN", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "GetItemByGTIN", xmlWriter);
			}
		...
		if (localRequestedGtinTracker) {
			...
			if (localRequestedGtin == null) {
				...
				xmlWriter.writeCharacters(localRequestedGtin);
	...
	public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
		...
		if (localRequestedGtinTracker) {
			elementList.add(new javax.xml.namespace.QName("http://www.gepir.gs1.org.vn/", "requestedGtin"));

			if (localRequestedGtin != null) {
				elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localRequestedGtin));
			} else {
				throw new org.apache.axis2.databinding.ADBException("requestedGtin cannot be null!!");
			}
		}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static GetItemByGTIN parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			GetItemByGTIN object = new GetItemByGTIN();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"GetItemByGTIN".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (GetItemByGTIN) vn.org.gs1.gepir.request.ExtensionMapper.getTypeObject(nsUri, type,
									reader);
						}
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("http://www.gepir.gs1.org.vn/", "requestedGtin")
								.equals(reader.getName())) {

					nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
					if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
						throw new org.apache.axis2.databinding.ADBException(
								"The element: " + "requestedGtin" + "  cannot be null");
					}

					java.lang.String content = reader.getElementText();

					object.setRequestedGtin(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
