                           ...
                           public  java.lang.String[] getRequestedGln(){
                             ...
                             */
                             public void addRequestedGln(java.lang.String param){
                               ...
                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localRequestedGln);
                               list.add(param);
                               this.localRequestedGln =
                                   ...
                                   for (int i = 0;i < localRequestedGln.length;i++){
                                            ...
                                            if (localRequestedGln[i] != null){
                                                ...
                                                writeStartElement(null, namespace, "requestedGln", xmlWriter);
                                                        ...
                                                        xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localRequestedGln[i]));
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetPartyByGLN".equals(type)){
                                ...
                                return (GetPartyByGLN)vn.org.gs1.gepir.request.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                                    ...
                                    list1.add(reader.getElementText());
                                            ...
                                            while(!loopDone1){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (new javax.xml.namespace.QName("http://www.gepir.gs1.org.vn/","requestedGln").equals(reader.getName())){
                                                         list1.add(reader.getElementText());
                                            ...
                                            // call the converter utility  to convert and set the array
                                                    ...
                                                    object.setRequestedGln((java.lang.String[])
